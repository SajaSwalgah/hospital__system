    ...
    if (!array_filter($errors)) {
        ...
        if (mysqli_num_rows($result) == 1) {
            ...
            if ($row['status'] === 'Pending') {
                $loggedIn = 'Please Wait for the Admin to confirm';
            } else if ($row['status'] === 'Rejected') {
                $loggedIn = 'Try again later';
            } else {
        ...
        <div class="col-md-12">
            <div class="row">
                ...
                <div class="col-md-6 jumbotron">
                    ...
                    <form action="doctor-login.php" method="POST" class="my-2">
                        ...
                        <p>You don't have an account?? <a href="apply.php">Apply now!</a></p>
